...
0.4.1.0. 07.02.2026. Для объекта Util реализовона возможность "трубы", т.е. выполнения нескольких команд, одна за одной. Также добавлен параметр кодовой страницы, с которой работает утилита или несколько утилит.  
