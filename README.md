...
0.4.2.0. 10.02.2026. Исправлен баг в методе WriteUtil().  Методы DoAsync() и DoAsyncN() теперь возвращают не цифровой код завершения, логическое значение успеха для единообоазия с RunAsync().  
