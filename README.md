...
0.3.0.0. 20.12.2025. Для объекта Util реализовоно перенаправление потока из канала ошибок в стандартный поток. Если есть оба потока, и стандартный и ошибки, то ошибки дописываются в конец стандартного потока вывода.  
