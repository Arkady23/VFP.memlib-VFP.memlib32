...
### Обсуждение
Задать вопрос или обсудить тему, касающуюся VFP/VFPA, вы можете в разделе проекта Issues > New issue. В отличае от русского Фоксклуба FoxClub.ru, где меня(kornienko_ru) заблокировал обиженный администратор Юрий Шутенко(Joys), гарантируется полная свобода суждений и мыслей.
### История версий
