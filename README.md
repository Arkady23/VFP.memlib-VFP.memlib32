...
[Пример использования асинхронной задачи на языке Visual FoxPro для распараллеливания расчета](#ПримериспользованияасинхроннойзадачинаязыкеVisualFoxProдляраспараллеливаниярасчета)  
