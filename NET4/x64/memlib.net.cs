...
namespace memlib {
  ...
  [ComVisible(true)]
  [Guid("9A4F3B21-C8D7-4E6A-AF15-5B6C7D8E9F01")]
  ...
  [ComVisible(true)]
  [Guid("B2C3D4E5-F6A7-4829-9101-112131415161")]   // фиксированный GUID для интерфейса
  ...
  [ComVisible(true)]
  [Guid("A1B2C3D4-E5F6-4718-8901-234567890ABC")]   // фиксированный GUID для класса
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  public class memlib : IMemLib {
    ...
    const int k0=0, k1=1, k_1=-1, n2=2048, maxInt=67108832;
